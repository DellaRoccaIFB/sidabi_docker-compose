<template>
    <v-card class="card-progress-scale-mbss" outlined :width="graph_width" :height="260">
        <v-card-title class="m0 p0 pl-2">
            ...
            Escala Multidimensional do Estado de Tédio
            </p>
        </v-card-title>
        ...
        <v-card class="card-total" max-width="400" height="120" width="185" color="#3175D3">
            <v-card-text class="card-total-text" width="100%">
                ...
                <div class="row parts">
                    <div>
                        <p class="text-h5" style="width: fit-content; color: white; padding: 10px; margin-left: 60px;">
                            {{ soma }}
                        </p>
                    </div>
                </div>
        ...
        <v-card class="card-info" max-width="400" height="120" width="185" color="#3175D3">
                <p class="text-h9" style="width: fit-content; color: white; font-size: 16px !important; padding: 10px; margin-left: 13px; margin-top: 0px; text-align: center;">
                    Pontuação
                    <br>
                    <br>
                    6 = Nada entediado

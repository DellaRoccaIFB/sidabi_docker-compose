<template>
    <v-card class="card-progress-scale-aes" 
        ...
        <v-card-title class="m0 p0 pl-2">
            ...
            Escala para Avaliação da Atividade (Escala de Ativação e Sensação)
            </p>
        </v-card-title>
        ...
        <v-card class="card-total" max-width="400" height="120" width="185" color="#3175D3">
            <v-card-text class="card-total-text" width="100%">
                ...
                <div class="row parts">
                    <div>
                        <p class="text-h5" style="width: fit-content; color: white; padding: 10px; margin-left: 65px;">
                            {{ soma }}
                        </p>
                    </div>
                </div>
        ...
        <v-card class="card-info" max-width="400" height="120" width="250" color="#3175D3">
                <p class="text-h9" style="width: fit-content; color: white; font-size: 14px !important; padding: 10px; margin-left: 0px; margin-top: 0px; text-align: center;">
                    Ativação | 1 (pouco ativo) a 6 (muito ativo).
                    <br>
                    Sensação | -5 (não gostou de realizar a atividade) a 5 (gostou de realizar a atividade).
                </p>
        </v-card>
        </div>
    </v-card>
